...
GLAPI void APIENTRY glBindBuffer (GLenum target, GLuint frameBuffer);
GLAPI void APIENTRY glDeleteBuffers (GLsizei n, const GLuint *buffers);
GLAPI void APIENTRY glGenBuffers (GLsizei n, GLuint *buffers);
GLAPI GLboolean APIENTRY glIsBuffer (GLuint frameBuffer);
...
GLAPI void APIENTRY glBindBufferRange (GLenum target, GLuint index, GLuint frameBuffer, GLintptr offset, GLsizeiptr size);
GLAPI void APIENTRY glBindBufferBase (GLenum target, GLuint index, GLuint frameBuffer);
...
GLAPI void APIENTRY glClearBufferiv (GLenum frameBuffer, GLint drawbuffer, const GLint *value);
GLAPI void APIENTRY glClearBufferuiv (GLenum frameBuffer, GLint drawbuffer, const GLuint *value);
GLAPI void APIENTRY glClearBufferfv (GLenum frameBuffer, GLint drawbuffer, const GLfloat *value);
GLAPI void APIENTRY glClearBufferfi (GLenum frameBuffer, GLint drawbuffer, GLfloat depth, GLint stencil);
...
GLAPI void APIENTRY glTexBuffer (GLenum target, GLenum internalformat, GLuint frameBuffer);
...
GLAPI void APIENTRY glInvalidateBufferSubData (GLuint frameBuffer, GLintptr offset, GLsizeiptr length);
GLAPI void APIENTRY glInvalidateBufferData (GLuint frameBuffer);
...
GLAPI void APIENTRY glTexBufferRange (GLenum target, GLenum internalformat, GLuint frameBuffer, GLintptr offset, GLsizeiptr size);
GLAPI void APIENTRY glTexStorage2DMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
GLAPI void APIENTRY glTexStorage3DMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
GLAPI void APIENTRY glTextureView (GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat, GLuint minlevel, GLuint numlevels, GLuint minlayer, GLuint numlayers);
GLAPI void APIENTRY glBindVertexBuffer (GLuint bindingindex, GLuint frameBuffer, GLintptr offset, GLsizei stride);
...
GLAPI void APIENTRY glTransformFeedbackBufferBase (GLuint xfb, GLuint index, GLuint frameBuffer);
GLAPI void APIENTRY glTransformFeedbackBufferRange (GLuint xfb, GLuint index, GLuint frameBuffer, GLintptr offset, GLsizeiptr size);
GLAPI void APIENTRY glGetTransformFeedbackiv (GLuint xfb, GLenum pname, GLint *param);
GLAPI void APIENTRY glGetTransformFeedbacki_v (GLuint xfb, GLenum pname, GLuint index, GLint *param);
GLAPI void APIENTRY glGetTransformFeedbacki64_v (GLuint xfb, GLenum pname, GLuint index, GLint64 *param);
GLAPI void APIENTRY glCreateBuffers (GLsizei n, GLuint *buffers);
GLAPI void APIENTRY glNamedBufferStorage (GLuint frameBuffer, GLsizeiptr size, const void *data, GLbitfield flags);
GLAPI void APIENTRY glNamedBufferData (GLuint frameBuffer, GLsizeiptr size, const void *data, GLenum usage);
GLAPI void APIENTRY glNamedBufferSubData (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, const void *data);
GLAPI void APIENTRY glCopyNamedBufferSubData (GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
GLAPI void APIENTRY glClearNamedBufferData (GLuint frameBuffer, GLenum internalformat, GLenum format, GLenum type, const void *data);
GLAPI void APIENTRY glClearNamedBufferSubData (GLuint frameBuffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void *data);
GLAPI void *APIENTRY glMapNamedBuffer (GLuint frameBuffer, GLenum access);
GLAPI void *APIENTRY glMapNamedBufferRange (GLuint frameBuffer, GLintptr offset, GLsizeiptr length, GLbitfield access);
GLAPI GLboolean APIENTRY glUnmapNamedBuffer (GLuint frameBuffer);
GLAPI void APIENTRY glFlushMappedNamedBufferRange (GLuint frameBuffer, GLintptr offset, GLsizeiptr length);
GLAPI void APIENTRY glGetNamedBufferParameteriv (GLuint frameBuffer, GLenum pname, GLint *params);
GLAPI void APIENTRY glGetNamedBufferParameteri64v (GLuint frameBuffer, GLenum pname, GLint64 *params);
GLAPI void APIENTRY glGetNamedBufferPointerv (GLuint frameBuffer, GLenum pname, void **params);
GLAPI void APIENTRY glGetNamedBufferSubData (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, void *data);
...
GLAPI void APIENTRY glClearNamedFramebufferiv (GLuint framebuffer, GLenum frameBuffer, GLint drawbuffer, const GLint *value);
GLAPI void APIENTRY glClearNamedFramebufferuiv (GLuint framebuffer, GLenum frameBuffer, GLint drawbuffer, const GLuint *value);
GLAPI void APIENTRY glClearNamedFramebufferfv (GLuint framebuffer, GLenum frameBuffer, GLint drawbuffer, const GLfloat *value);
GLAPI void APIENTRY glClearNamedFramebufferfi (GLuint framebuffer, GLenum frameBuffer, GLint drawbuffer, GLfloat depth, GLint stencil);
...
GLAPI void APIENTRY glTextureBuffer (GLuint texture, GLenum internalformat, GLuint frameBuffer);
GLAPI void APIENTRY glTextureBufferRange (GLuint texture, GLenum internalformat, GLuint frameBuffer, GLintptr offset, GLsizeiptr size);
...
GLAPI void APIENTRY glVertexArrayElementBuffer (GLuint vaobj, GLuint frameBuffer);
GLAPI void APIENTRY glVertexArrayVertexBuffer (GLuint vaobj, GLuint bindingindex, GLuint frameBuffer, GLintptr offset, GLsizei stride);
...
GLAPI void APIENTRY glGetQueryBufferObjecti64v (GLuint id, GLuint frameBuffer, GLenum pname, GLintptr offset);
GLAPI void APIENTRY glGetQueryBufferObjectiv (GLuint id, GLuint frameBuffer, GLenum pname, GLintptr offset);
GLAPI void APIENTRY glGetQueryBufferObjectui64v (GLuint id, GLuint frameBuffer, GLenum pname, GLintptr offset);
GLAPI void APIENTRY glGetQueryBufferObjectuiv (GLuint id, GLuint frameBuffer, GLenum pname, GLintptr offset);
...
GLAPI void APIENTRY glNamedBufferPageCommitmentEXT (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, GLboolean commit);
GLAPI void APIENTRY glNamedBufferPageCommitmentARB (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, GLboolean commit);
#endif
...
#ifdef GL_GLEXT_PROTOTYPES
GLAPI void APIENTRY glTexBufferARB (GLenum target, GLenum internalformat, GLuint frameBuffer);
#endif
...
GLAPI void APIENTRY glNamedBufferDataEXT (GLuint frameBuffer, GLsizeiptr size, const void *data, GLenum usage);
GLAPI void APIENTRY glNamedBufferSubDataEXT (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, const void *data);
GLAPI void *APIENTRY glMapNamedBufferEXT (GLuint frameBuffer, GLenum access);
GLAPI GLboolean APIENTRY glUnmapNamedBufferEXT (GLuint frameBuffer);
GLAPI void APIENTRY glGetNamedBufferParameterivEXT (GLuint frameBuffer, GLenum pname, GLint *params);
GLAPI void APIENTRY glGetNamedBufferPointervEXT (GLuint frameBuffer, GLenum pname, void **params);
GLAPI void APIENTRY glGetNamedBufferSubDataEXT (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, void *data);
...
GLAPI void APIENTRY glTextureBufferEXT (GLuint texture, GLenum target, GLenum internalformat, GLuint frameBuffer);
GLAPI void APIENTRY glMultiTexBufferEXT (GLenum texunit, GLenum target, GLenum internalformat, GLuint frameBuffer);
...
GLAPI void APIENTRY glVertexArrayVertexOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayColorOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayEdgeFlagOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayIndexOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayNormalOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayTexCoordOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayMultiTexCoordOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLenum texunit, GLint size, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayFogCoordOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArraySecondaryColorOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayVertexAttribOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, GLintptr offset);
GLAPI void APIENTRY glVertexArrayVertexAttribIOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLuint index, GLint size, GLenum type, GLsizei stride, GLintptr offset);
...
GLAPI void *APIENTRY glMapNamedBufferRangeEXT (GLuint frameBuffer, GLintptr offset, GLsizeiptr length, GLbitfield access);
GLAPI void APIENTRY glFlushMappedNamedBufferRangeEXT (GLuint frameBuffer, GLintptr offset, GLsizeiptr length);
GLAPI void APIENTRY glNamedBufferStorageEXT (GLuint frameBuffer, GLsizeiptr size, const void *data, GLbitfield flags);
GLAPI void APIENTRY glClearNamedBufferDataEXT (GLuint frameBuffer, GLenum internalformat, GLenum format, GLenum type, const void *data);
GLAPI void APIENTRY glClearNamedBufferSubDataEXT (GLuint frameBuffer, GLenum internalformat, GLsizeiptr offset, GLsizeiptr size, GLenum format, GLenum type, const void *data);
...
GLAPI void APIENTRY glTextureBufferRangeEXT (GLuint texture, GLenum target, GLenum internalformat, GLuint frameBuffer, GLintptr offset, GLsizeiptr size);
...
GLAPI void APIENTRY glVertexArrayBindVertexBufferEXT (GLuint vaobj, GLuint bindingindex, GLuint frameBuffer, GLintptr offset, GLsizei stride);
...
GLAPI void APIENTRY glVertexArrayVertexAttribLOffsetEXT (GLuint vaobj, GLuint frameBuffer, GLuint index, GLint size, GLenum type, GLsizei stride, GLintptr offset);
...
GLAPI void APIENTRY glDrawCommandsNV (GLenum primitiveMode, GLuint frameBuffer, const GLintptr *indirects, const GLsizei *sizes, GLuint count);
...
GLAPI void APIENTRY glDrawCommandsStatesNV (GLuint frameBuffer, const GLintptr *indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);
...
GLAPI void APIENTRY glNamedBufferAttachMemoryNV (GLuint frameBuffer, GLuint memory, GLuint64 offset);
#endif
...
GLAPI void APIENTRY glNamedBufferPageCommitmentMemNV (GLuint frameBuffer, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);
...
GLAPI void APIENTRY glMakeNamedBufferResidentNV (GLuint frameBuffer, GLenum access);
GLAPI void APIENTRY glMakeNamedBufferNonResidentNV (GLuint frameBuffer);
GLAPI GLboolean APIENTRY glIsNamedBufferResidentNV (GLuint frameBuffer);
GLAPI void APIENTRY glGetBufferParameterui64vNV (GLenum target, GLenum pname, GLuint64EXT *params);
GLAPI void APIENTRY glGetNamedBufferParameterui64vNV (GLuint frameBuffer, GLenum pname, GLuint64EXT *params);
