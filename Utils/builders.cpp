...
util::BlueprintNodeBuilder::BlueprintNodeBuilder(ImTextureID texture, int textureWidth, int textureHeight) :
    ...
    headerTextureW(textureWidth),
    headerTextureH(textureHeight),
    currentNode(0),
...
void util::BlueprintNodeBuilder::End()
{
    ...
    if (ImGui::IsItemVisible())
    {
        ...
        auto headerColor = IM_COL32(0, 0, 0, alpha) | (headerColour & IM_COL32(255, 255, 255, 0));
